...
[[nodiscard]] SceneRect scene_actor_bounds(ScenePoint center, SceneSize size) noexcept;
[[nodiscard]] bool scene_position_is_free(const IndoorSceneLayout& layout,
                                          ScenePoint center,
                                          SceneSize size) noexcept;
[[nodiscard]] ScenePoint move_with_scene_collisions(const IndoorSceneLayout& layout,
                                                    ScenePoint current,
                                                    ScenePoint delta,
                                                    SceneSize size) noexcept;
