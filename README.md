...
- 2026-07-11 起暂缓视觉输入未就绪的 Issue 24-26 与 28；2026-07-13 团队提供的餐馆、家和图书馆合成稿已接入运行时，图书馆静态碰撞基础完成后 Issue 27 恢复为 `ready-for-agent`。分件生成、人工拼接、碰撞交接和恢复门槛见 [`docs/SCENE_ASSET_PRODUCTION_PLAN.md`](docs/SCENE_ASSET_PRODUCTION_PLAN.md)。
...
地点 UI 诊断截图可通过 `./build/pixel_town --capture-ui-diagnostics` 生成到被 Git 忽略的 `ui-diagnostics-captures/`；其中包含便利店长结算摘要地图、酒馆大厅、玩法选择、五子棋、骗子骰子，以及酒保对话首句、中间句、末句和缺图 fallback 页面。
