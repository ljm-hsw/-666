...
- Issue 24 已按 TDD 完成餐馆老板固定热点、三句主线初识对话和原餐馆玩法交接；对话关闭前阶段、订单和倒计时均不推进。Issue 25/26 仍暂缓，支线剧情继续延期。
- 2026-07-13 团队提供的餐馆、家、图书馆、酒馆和便利店合成稿均已接入运行时。2026-07-14 Issue 27/28 按固定 NPC 待机与点击热点方案收口，不再依赖移动或碰撞。
- 餐馆、便利店、图书馆和家现统一为“地图 → 场景大厅 → NPC 互动/返回 → 进入原玩法”的入口；餐馆和图书馆已接正式线性对话，便利店和家仍为预留互动。进入大厅不消耗行动且不写入存档，酒馆保留专用大厅。
