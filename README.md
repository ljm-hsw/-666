...
地点 UI 诊断截图可通过 `./build/pixel_town --capture-ui-diagnostics` 生成到被 Git 忽略的 `ui-diagnostics-captures/`；当前共 57 张，其中包含四个通用场景大厅、人物待机/对话槽、五套碰撞覆盖图、地点剧情、酒馆玩法，以及六张主角靠近餐馆老板、便利店店主、图书管理员、酒馆双桌和家中床铺的移动/邻近互动证据。
