...
TEST_CASE("liars dice seed combines session day and result identity") {
    const auto seed = make_liars_dice_seed(20260710U, 3, 7);
    CHECK(seed == make_liars_dice_seed(20260710U, 3, 7));
    CHECK(seed != make_liars_dice_seed(20260711U, 3, 7));
    CHECK(seed != make_liars_dice_seed(20260710U, 4, 7));
    CHECK(seed != make_liars_dice_seed(20260710U, 3, 8));
}
