...
TEST_CASE("production baseline manifest keeps the startup resource contract") {
    ...
    require_spec("textures/ui/tavern/npc/bartender_idle_sheet.png", ResourceKind::texture,
                 false);
    require_spec("textures/ui/restaurant/npc/chef_idle_sheet.png", ResourceKind::texture,
                 false);
    require_spec("textures/ui/convenience_store/npc/salesclerk_idle_sheet.png",
                 ResourceKind::texture, false);
    ...
    require_spec("textures/ui/characters/protagonist_idle_sheet.png",
                 ResourceKind::texture, false);
    require_spec("textures/ui/characters/mayor_idle_sheet.png",
                 ResourceKind::texture, false);
    ...
    require_spec("textures/ui/library/old_town_map.png", ResourceKind::texture, false);
