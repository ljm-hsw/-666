...
从地图点击餐馆、便利店、图书馆或家后，会先进入不消耗行动的场景大厅。餐馆可点击老板/主要活动按钮或按 `Enter`/`Space` 打开短对话；图书馆可点击管理员或按 `Space` 打开短对话。两者关闭或跳过后才进入原有玩法，便利店和家仍显示预留互动。大厅可以直接返回地图且不消耗阶段，酒馆继续使用自己的大厅交互。
