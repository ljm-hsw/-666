...
人物小人和轻量对话采用可替换占位视觉先完成基础功能，再由最终视觉 issue 统一替换。所有 NPC 固定在柜台或作者指定热点循环待机动画；Issue 33 只恢复五个固定室内场景的有限主角移动、静态碰撞和邻近互动，不加入 NPC 巡逻、路点、寻路或开放世界。触发矩阵、输入拦截和存档约束见 [`CHARACTER_DIALOGUE_PLAN.md`](CHARACTER_DIALOGUE_PLAN.md)。Issue 23-32 是已完成的自动垂直切片，Issue 33 的代码/截图证据已完成但保留 macOS 与 Windows 物理键盘 HITL 门禁；人物造型、热点可发现性、事件密度和最终文案仍分别由 Issue 16/17 人工批准。

2026-07-11 临时执行调整：Issue 23 保持完成；Issue 24-28 最初改为 `needs-info`，先按 [`SCENE_ASSET_PRODUCTION_PLAN.md`](SCENE_ASSET_PRODUCTION_PLAN.md) 完成视觉输入。2026-07-13 团队提供的餐馆、家、图书馆、酒馆和便利店 960×540 合成稿已接入。2026-07-14 用户恢复以现有主线为基准的对话实施，Issue 24-26 均已完成，其既有依赖和验收标准保持不变。
...
2026-07-14 主线实施边界：当前对话只延伸既有主线和 A 级 NPC 的初识语气，不新增条件分支、好感度、任务链、已读状态或存档字段。Issue 24/25 通过通用固定 NPC 大厅运行期完成餐馆老板和便利店店主对话；Issue 26 通过独立生命周期运行期完成镇长/主角开场与回家独白。所有对话关闭后才交回原流程，B/C 级支线继续延期。

2026-07-15 地点剧情扩展：完成的 Issue 23-28 保留为固定 NPC、共享对话和首访教程基线，不重新打开。Issue 30 已完成五地点完成访问次数、v1→v2 存档迁移和确定性事件选择器；Issue 31/32 分别接入白天地点与酒馆/家的第 2-10 天事件。首批意外事件只改变对话和提示，玩法数值影响必须经过 Issue 16 人工平衡批准。

2026-07-16 有限导航恢复：不重新打开已完成的 Issue 27/28，新建 Issue 33 统一承接五地点主角 WASD/方向键移动、静态碰撞、邻近 E/Space 互动和跨平台实机验收。导航与碰撞属于 raylib-free 核心展示规则，NPC、对话、地点玩法、行动结果和 v2 存档契约保持不变。
...
| [30 建立地点剧情上下文与存档迁移](../.scratch/pixel-town-ten-day-plan/issues/30-p4-location-story-context.md) | AFK | 05、06、19、23 | 已完成：五地点访问次数、v1→v2 迁移、选择优先级和确定性 |
| [31 接入白天地点首访教程与剧情事件](../.scratch/pixel-town-ten-day-plan/issues/31-p4-day-location-story-events.md) | AFK | 24、25、27、29、30 | 已完成：三个白天地点首访、日常/意外事件、输入冻结、原玩法交接和 42 张诊断截图 |
| [32 接入酒馆与家首访教程和剧情事件](../.scratch/pixel-town-ten-day-plan/issues/32-p4-night-home-story-events.md) | AFK | 23、26、28、30 | 已完成：酒馆首访/事件、每次回家访客、桌游交接、休息幂等和 9 张夜晚剧情诊断截图 |
| [33 接入五地点室内移动、静态碰撞与邻近互动](../.scratch/pixel-town-ten-day-plan/issues/33-p4-indoor-navigation-and-collision.md) | HITL | 24、25、27、28、32 | 规则/截图已完成；待 macOS 与 Windows 物理 WASD/方向键、碰撞和 E/Space 人工验收 |
| [16 完成内容扩充与数值平衡](../.scratch/pixel-town-ten-day-plan/issues/16-p4-content-and-balance.md) | HITL | 09-15、22、24-32 | 固定种子模拟、剧情事件/人物热点试玩记录和批准参数 |
| [17 完成像素美术、音频、教程与署名](../.scratch/pixel-town-ten-day-plan/issues/17-p4-presentation-and-credits.md) | HITL | 03、09-11、13-15、22-32 | 最终人物待机动画/场景资源、事件截图、许可、教程和人工验收 |
...
- 核心与集成负责人优先处理 01、04-08、15、18、30、33，并维护共享契约、存档迁移和导航/碰撞布局。
- 餐馆负责人主责 09；便利店负责人主责 10；图书馆负责人主责 11。
- 酒馆与展示负责人主责 03、12-14、17、23、28、32，与餐馆/便利店/图书馆负责人共同推进 24、25、27、31，并与核心负责人共同推进 26、30 和 18。
