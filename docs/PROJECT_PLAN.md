...
2026-07-10 集成说明：`codex/integrate-team-branches` 已从 `origin/dev-ckz@6ebaddd` 分层移植五子棋、骗子骰子和酒馆候选素材。Issue 13/14 的真实玩法已替换模拟成功外壳；Issue 22 进一步以显式帧输入、只读 presentation 和独立 Settlement Module 收口酒馆流程。规则与 Runtime 可无窗口测试，统一 `ActionResult`、数值和 v1 存档格式未改变。
...
| Issue | 类型 | 依赖 | 独立证据 |
| --- | --- | --- | --- |
| [16 完成内容扩充与数值平衡](../.scratch/pixel-town-ten-day-plan/issues/16-p4-content-and-balance.md) | HITL | 09-15、22 | 固定种子模拟、人工试玩记录和批准参数 |
| [17 完成像素美术、音频、教程与署名](../.scratch/pixel-town-ten-day-plan/issues/17-p4-presentation-and-credits.md) | HITL | 03、09-11、13-15、22 | 最终资源、许可、教程和人工视觉验收 |
