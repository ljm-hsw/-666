...
| P3 | 夜晚与结局 | 三个白天地点及对应 blocker 完成 | 酒馆双玩法、最终库存清算和七种主结局进入完整循环 |
...
| Issue | 类型 | 依赖 | 独立证据 |
| --- | --- | --- | --- |
| [12 接入酒馆选择、赌注与夜晚结算](../.scratch/pixel-town-ten-day-plan/issues/12-p3-tavern-shell.md) | AFK | 09、10、11 | 每晚一次挑战选择与统一结算 |
...
| [15 完成库存清算与七种主结局](../.scratch/pixel-town-ten-day-plan/issues/15-p3-endings.md) | AFK | 05、06、10、13、14 | 第十日完整结算与唯一主结局 |
...
- 酒馆与展示负责人主责 03、12-14、17，并与核心负责人共同完成 07、18。
