...
人物小人、轻量对话和有限室内移动采用可替换占位视觉先完成基础功能，再由最终视觉 issue 统一替换。共享边界、32×32 占位帧、方向键输入、静态碰撞、NPC 路点、触发矩阵、输入拦截和存档约束见 [`CHARACTER_DIALOGUE_PLAN.md`](CHARACTER_DIALOGUE_PLAN.md)。Issue 23-28 是可自动实施的垂直切片；人物造型、移动手感、最终文案密度和视觉/碰撞一致性仍分别由 Issue 16/17 人工批准。
...
| [16 完成内容扩充与数值平衡](../.scratch/pixel-town-ten-day-plan/issues/16-p4-content-and-balance.md) | HITL | 09-15、22、24-28 | 固定种子模拟、人物文案/移动试玩记录和批准参数 |
| [17 完成像素美术、音频、教程与署名](../.scratch/pixel-town-ten-day-plan/issues/17-p4-presentation-and-credits.md) | HITL | 03、09-11、13-15、22-28 | 最终人物/场景资源、视觉/碰撞一致性、许可、教程和人工验收 |
