...
Issue 24/25 已用程序人物 fallback 完成餐馆老板、便利店店主固定热点和主线初识对话；最终人物图仍等待 Issue 17 人工批准。Issue 26 继续等待镇长/主角视觉输入，Issue 27/28 已按固定管理员、固定酒保与点击热点方案完成。这不改变已经通过的 P1-P3 规则验收，也不允许候选美术反向修改地点规则。
