...
本目录保存《像素小镇：十日经营计划》的主线剧情与文案设计资料。

## 文件

- [`像素小镇_剧情设计文档.docx`](像素小镇_剧情设计文档.docx)：原始 Word 文档归档版，保留给人工审阅和版式确认。
- [`PIXEL_TOWN_STORY_DESIGN.md`](PIXEL_TOWN_STORY_DESIGN.md)：从 Word 文档提取的可检索 Markdown 版本，供 issue、代码和设计文档引用。
- [`NARRATIVE_OVERVIEW.md`](NARRATIVE_OVERVIEW.md)：总剧情、世界观、优先级层级和 P0-P4 阶段关系。
