...
- 2026-07-16：补充 Windows 便携安装布局、MSVC `/utf-8`、EXE 旁资源优先定位和十日/五日双构建 CI。macOS 使用安装后的五日目录从仓库外工作目录启动并完成三张流程截图，资源与音频诊断均为 ready；Windows/MSVC CI 与目标 Windows 实机烟雾测试仍待远端和人工证据，不能据此勾选本 issue。
