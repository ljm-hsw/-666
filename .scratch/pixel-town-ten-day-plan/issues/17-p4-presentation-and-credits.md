...
- 2026-07-15：接入团队提供的餐馆厨师、便利店售货员、图书管理员、酒保和主角 `4×64×96` RGBA 精灵表。四类固定 NPC 用于场景待机和对话人物槽，主角用于各地点、开场与回家剧情人物槽；对话头像统一固定第 1 帧并居中，不继承场景动画。五套共 20 帧满足当前规格，实机诊断截图用于检查人物、标签、热点和对话框对齐，未因凑帧数调用 imagegen。原作者、生成工具和再分发/商用许可仍待团队补齐，因此本 Issue 的最终美术与许可验收保持未完成。
