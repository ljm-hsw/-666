...
- 2026-07-15：接入团队提供的餐馆厨师、便利店售货员、图书管理员和酒保 `4×64×96` RGBA 待机表，统一用于场景小人和对话人物槽。四套 16 个单帧哈希均不同，45/45 张实机诊断截图成功导出；四类 NPC 均有至少两个运行时间点证据，人物、标签、热点和对话框对齐。未因凑帧数调用 imagegen。原作者、生成工具和再分发/商用许可仍待团队补齐，因此本 Issue 的最终美术与许可验收保持未完成。
